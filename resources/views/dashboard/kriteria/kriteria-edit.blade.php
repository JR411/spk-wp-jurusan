...
@section('title', 'Edit Kriteria '.$kriteria->kriteria_nama)
                ...
                <div class="white_shd full margin_bottom_30">
                    <div class="full graph_head d-flex justify-content-between align-items-center">
                        <div class="heading1 margin_0">
                            <h2>Edit Kriteria {{ $kriteria->kriteria_nama }}</h2>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="full">
                                    <div class="padding_infor_info">
                                        ...
                                        @endif
                                        <form action="/dashboard/kriteria/{{ $kriteria->id }}" method="post">
                                            @method('put')
                                            @csrf
                                            <div class="form-group">
                                                ...
                                                <input id="kriteria_nama" type="text" name="kriteria_nama" placeholder="Kriteria" required
                                                    value="{{ old('kriteria_nama', $kriteria->kriteria_nama) }}" class="form-control @error('kriteria_nama') is-invalid @enderror">
                                                @error('kriteria_nama')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <input type="range" min="0.001" max="1.000" step="0.001" style="width: 30%;" value="{{ old('kriteria_bobot', $kriteria->kriteria_bobot) }}"
                                                    name="kriteria_bobot" id="scale" oninput="updateTextInput(this.value);">
                                                <input type="text" id="textInput" class="form-control d-inline" style="width: 69.7%;" value="{{ old('kriteria_bobot', $kriteria->kriteria_bobot) }}"
