...
@section('title', 'Edit Jurusan '.$jurusan->jurusan_nama)
                ...
                <div class="white_shd full margin_bottom_30">
                    <div class="full graph_head d-flex justify-content-between align-items-center">
                        <div class="heading1 margin_0">
                            <h2>Edit Jurusan {{ $jurusan->jurusan_nama }}</h2>
                        </div>
                    </div>
                                        ...
                                        <form action="/dashboard/jurusan/{{ $jurusan->id }}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="jurusan_nama" type="text" name="jurusan_nama" placeholder="Nama Jurusan" required
                                                    value="{{ old('jurusan_nama', $jurusan->jurusan_nama) }}" class="form-control @error('jurusan_nama') is-invalid @enderror">
                                                @error('jurusan_nama')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="peminatan_id" name="peminatan_id" required
                                                    ...
                                                    @foreach ($peminatans as $item)
                                                        <option value="{{ $item->id }}" {{ old('peminatan_id', $jurusan->peminatan_id) == $item->id ? 'selected' : '' }}>
